...
if(isset($_SESSION['userID'])){
        ...
        $query = "SELECT FirstName, MiddleName,Surname, PhoneNO,Email, 
                Departments, RegNumber, RefNum
                FROM onlineApplications WHERE RegNumber='$matricI'";
        $query = mysqli_query($con, $query) or die (mysqli_error($con));
