                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Generate 2020/21 Application Invoice</h3></div>
                                    <div class="card-body">
                                            ...
                                            echo $cc;
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputPayingFor" name="payingFor" type="text" placeholder="What Are You Paing Form?" value="2020/21 Application Form"  readonly/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
