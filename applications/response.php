...
<html lang="en">
    ...
    <body >
     ...
     <script src="https://code.jquery.com/jquery-3.1.1.min.js">
       ...
       <script>
        $.ajax({   
                            url:"/rrr-paymentstatus.php?user=<?php echo $username; ?>&rrr=<?php echo $rrrget;?>&orderId=<?php echo $orderIDget; ?>",
                            type: 'POST',
                            cache:false,
                            //data: dataString,
                            beforeSend: function() {},
                            ...
                            success: function(response) {
                                $("#response").html(response+', Please wait a moment we are processing your redirect ......');
                               // alert("Deposit Placed");
                                ...
                                if(response === 'Payment successful and approved'){
                                    setTimeout(function() { 
                                    window.location.href = "/print_success_invoice.php";
       ...
       <script>
        $.ajax({   
                   url:"/rrr-paymentstatus.php?user=<?php echo $username; ?>&rrr=<?php echo $rrrget; ?>&statusGet=<?php echo $statusget; ?>&statusCodeGet=<?php echo $statuscodeget; ?>",
                            type: 'POST',
                            cache:false,
                            //data: dataString,
                            beforeSend: function() {},
