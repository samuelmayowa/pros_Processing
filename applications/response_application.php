...
<html lang="en">
    ...
    <body >
     ...
     <script src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
       ...
       <script>
        $.ajax({   
                            url:"/rrr-paymentstatus-application.php?user=<?php echo $username; ?>&rrr=<?php echo $rrrget;?>&orderId=<?php echo $orderIDget; ?>",
                            type: 'POST',
                            cache:false,
                            //data: dataString,
                            beforeSend: function() {},
       ...
       <script>
        $.ajax({   
                   url:"/rrr-paymentstatus-application.php?user=<?php echo $username; ?>&rrr=<?php echo $rrrget; ?>&statusGet=<?php echo $statusget; ?>&statusCodeGet=<?php echo $statuscodeget; ?>",
                            type: 'POST',
                            cache:false,
                            //data: dataString,
                            beforeSend: function() {},
