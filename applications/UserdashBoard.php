        ...
        <button type="button" class="btn btn-primary"><div class="small"><a href="photoCard.php?user=<?php echo $_SESSION['user'];  ?>" class="btn btn-primary btn-block">Re-Print PhotoCard</a></div></button>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                      <div class="small"><a href="https://applications.escohsti-edu.ng/manual-rrr-acp.php" class="btn btn-primary btn-block">Validate ACCEPTANCE FEE  Fees</a></div>
                                    ...
                                    <?php 
                                                ...
                                                $is_admission=checkadmission($con,$regNum);
                                                if($is_admission == $regNum && $acpt ==1){ ?>
                                    <div class="small"><a href="payComp.php?msg=<?php echo $_SESSION['regNum']; ?>"><button  type="button" name="compulsory" class="btn btn-primary btn-block" >Pay Compulsory Fees (#75,000)</button></a></div>
                                        <?php } ?>
                                        </div>
                                        </div>
                                        </div>
