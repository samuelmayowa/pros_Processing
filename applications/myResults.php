                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                         <div class="form-group">
                                            <div class="form-group mt-4 mb-0"><button  type="button" name="admStatus" class="btn btn-primary btn-block" ><?php if($admStatus ==1){ echo $adm = "Congratulations!," .'<br />'. "You Have Been Provisioned An Admission"; } else { echo "No Admission Has Been Provissioned for You Yet"; } ?></button></div>
                                             </div>
        ...
        "<td>".  $rs['Maths'] . "</td>" .
         ...
         "<td>" . $rs['Phy'] . "</td>" .
          ...
          "</tr>";
                                        ...
                                        <label class="small mb-1" for="inputFirstName">Total Score:<?php echo $tot;  ?></label><br>
                                        <label class="small mb-1" for="inputFirstName">Average Score:<?php echo $avg; ?></label>
