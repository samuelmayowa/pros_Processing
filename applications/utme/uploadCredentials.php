...
// Get RRR Details
    $type = '2021/2022 Post UTME Application Form';
...
$user = $_SESSION['user'];
if($app_exist=mysqli_query($con,"SELECT RefNumber FROM Credentials WHERE RefNumber ='$refNNum'")){
    
    if($ref=mysqli_num_rows($app_exist)){
        if($ref ==1){
            $getSts=mysqli_query($con,"SELECT Status FROM onlineApplications WHERE RefNum ='$refNNum'");
   ...
   if(isset($_POST['submitCred'])){
    $screenData = filter_var_array($_POST, FILTER_SANITIZE_STRING);
     ...
     /* if($examYear!=)*/
      ...
      $geo = $screenData['geo'];
      //$refNum = "5234532782632784238";
        if($ref==1 || $stAppl<=2){
             $query = mysqli_query($con, 
                                        "UPDATE Credentials SET ExamType='$exType', ExamYear='$examYear', maths='$maths',eng='$eng',chem='$chem',
                                    phys='$phys',biol='$bio', agric='$agric',econs='$econs',geog='$geo',civic='$civic' WHERE RegNumber='$regNum'");
                                    if(!$query){
                                        $msg= "Unbale to Submit Credentials:  ".mysqli_error($con);
                                        //echo $msg="<script> alert('Unable to Submit Credentials'); </script>";
                                    }else{
                                        $query = mysqli_query($con, 
                                    "UPDATE  onlineApplications SET  Status=2 WHERE RefNum ='$refNNum'") or die(mysqli_error($con));
                                        echo $msg="<script> alert('Credentials Submitted Successfully'); </script>";
                                        header('location:uploadPassport.php?refNum='.$refNNum);
                                    }
        }else{
        $query = mysqli_query($con, 
                                    "INSERT INTO Credentials(RegNumber,RefNumber, ExamType, ExamYear, maths,eng,chem,
                                    phys,biol, agric,econs,geog,civic)
                                    VALUES('$regNum','$refNNum','$exType','$examYear','$maths','$eng','$chem','$phys', '$bio','$agric','$econs','$geo',
                                    '$civic')");
                                    if(!$query){
                                        $msg= "Unbale to Submit Credentials:  ".mysqli_error($con);
                                        //echo $msg="<script> alert('Unable to Submit Credentials'); </script>";
                ...
                <main>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Applicant's Credentials Upload</h3></div>
                                     <div class="card-body"><span style="color:red;"><?php if(isset($msg)){ echo $msg; }else { echo $_GET['msg']; } ?></span>
                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputLastName">Exam Year</label><span style="color:red; font-size:10px; font-familiy:comic Sans MS">NOTE: ALL Awaiting Results Applicants Must Enter The Exam Year for The Results They Awaits</span>
                                                       <!-- <input type="month" id="start" name="exYear"  min="2018-03"  value="">-->
                                                        <input class="form-control py-4" id="inputLastName" type="YEAR" name="exYear"   value="<?php if(isset($_POST['exYear'])){ echo $_POST['exYear']; } ?>"  placeholder="2021-05" required />
                                                    </div>
                                                </div>
                                           </div>
                                             ...
                                             <div class="form-row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputPassword" name="eng" type="text" placeholder="SubGrade"  value="<?php if(isset($_POST['eng'])){ echo $_POST['eng']; } ?>" required />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputConfirmPassword">Maths</label>
                                                        <input  id="inputProg" class="form-control py-4" name="maths" type="text" placeholder="SubGrade"  value="<?php if(isset($_POST['maths'])){ echo $_POST['maths']; } ?>" required />   </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputPassword">Biology</label>
                                                        <input class="form-control py-4" id="inputPassword" name="bio" type="text" placeholder="SubGrade"  value="<?php if(isset($_POST['bio'])){ echo $_POST['bio']; } ?>"  required />
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="form-row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input  id="inputProg" class="form-control py-4" name="phys" type="text" placeholder="SubGrade"  value="<?php if(isset($_POST['phys'])){ echo $_POST['phys']; } ?>" required />                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputPassword">Chemistry</label>
                                                        <input class="form-control py-4" id="inputPassword" name="chem" type="text" placeholder="SubGrade"  value="<?php if(isset($_POST['chem'])){ echo $_POST['chem']; } ?>"  />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputConfirmPassword">Econs </label>
                                                        <input  id="inputProg" class="form-control py-4" name="econs" type="text" placeholder="SubGrade"  value="<?php if(isset($_POST['econs'])){ echo $_POST['econs']; } ?>"  /> </div>
                                                </div>
                                                </div>
                                                <div class="form-row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputPassword" name="agric" type="text" placeholder="SubGrade"  value="<?php if(isset($_POST['agric'])){ echo $_POST['agric']; } ?>"  />
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
