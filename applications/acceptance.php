...
if(!$score){
 ...
 $type_notPaid = '2021/2022 Acceptance Fee';
 $type_Paid = '2021/2022 Acceptance Fee';
   ...
   // $statusCode = $rrdata_notPaid['rrr_statuscode'];
    ...
    header("location:acceptanceInvoice.php");
}elseif(!empty($rrdata_Paid)){
    header("location:print_success_accept.php");
}

                                                // Fetch Department
                                                $amount="";
                                                $sql_department = "SELECT Amount FROM paymentCategories WHere payCategories='Acceptance'";
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Generate Invoice For 2021/2022 Acceptance Fee</h3></div>
                                    <div class="alert"></div>
...
<p id="status"></p>
                                    <div class="card-body">
                                        <form action="acceptanceInvoice.php" method="POST"> 
                                            <div class="form-row">
                                                <div class="col-md-6">
...
function clickButton() {
  ...
  s.src = "rrr-generate-acceptance.php?user=<?php echo $user;?>";
