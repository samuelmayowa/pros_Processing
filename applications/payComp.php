...
if(!$score){
 ...
 $type_notPaid = '2021/2022 Compulsory Fee';
 $type_Paid = '2021/2022 Compulsory Fee';
   ...
   // $statusCode = $rrdata_notPaid['rrr_statuscode'];
    ...
    header("location:compInvoice.php");
}elseif(!empty($rrdata_Paid)){
    header("location:print_success_comp.php");
}

                                                // Fetch Department
                                                $amount="";
                                                $sql_department = "SELECT Amount FROM paymentCategories WHere payCategories LIKE 'Compulsory %'";
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Generate Invoice For 2021/2022 Compulsory Fee</h3></div>
                                    <div class="alert"></div>
...
<p id="status"></p>
                                    <div class="card-body">
                                        <form action="compInvoice.php" method="POST"> 
                                            <div class="form-row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-row">
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputConfirmPassword">Decription</label>
                                                        <input class="form-control py-4" id="inputPayingFor" name="payingFor" type="text" placeholder="What Are You Paying For?" value="<?php echo $type_Paid;?>"  readonly/>
                                                    </div>
                                                </div>
                                            
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Compulsory Fee</label>
...
function clickButton() {
  ...
  s.src = "rrr-generate-comp.php?user=<?php echo $user;?>";
