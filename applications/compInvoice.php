...
if(isset($_POST['invoice'])){
    ...
    if($statusCode == '025' && !empty($refNNum)){
       ...
       header("location:payComp.php?user={$username}"); 
    }
    if($success){
        $msg=$success;
            ...
            <ul class="navbar-nav ml-auto ml-md-0" style="color:#fff;">
                ...
                <main>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Invoice For 2021/2022 Compulsory Fee </h3></div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="payCompulsory.php" method="POST"> 
                                            <div class="form-row">
                                                <div class="col-md-6">
                                       ...
                                       <div class="col-md-6">
                                            ...
                                            <div class="form-group mt-4 mb-0"> <a  href="/manual-rrr-comp.php"  class="btn btn-primary btn-block" >Validate RRR</a></div>
                                            </div>
                                            </div>
                                            <div class="form-row">
                                                <!--<div class="col-md-6">
