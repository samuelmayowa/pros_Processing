...
$adminContact = "Mail : admin@escohsti-edu.ng <br />
  ...
  if(empty($rrdataPaid)){
      if(empty($rrdataNotPaid)){
          ...
          header("location:acceptanceInvoice.php?user={$username}");
      }
         ...
         <?php include('topbar.php'); ?>
                ...
                <main>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Receipt For 2021/2022 Acceptance Fee</h3></div>
