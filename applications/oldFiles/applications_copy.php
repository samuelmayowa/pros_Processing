      ...
      $_SESSION['regNum'] = $regNum;
        $query = mysqli_query($con, 
                                    ...
                                    if(!$query){
                                        ...
                                        // echo $msg="<script> alert('Unable to Submit Applications'); </script>";
                                        header('location:uploadCredentials_copy.php?regNum='.$refNum .' && msg=Application Saved Successfully ');
                                    }
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Online Application Form for 2021/2022 Admission</h3></div>
                                     <div class="card-body"><span style="color:red; font-size:12px; font-family:comic sans MS;"><?php if(isset($_GET['msg'])){ echo $_GET['msg'];  }?> <?php if(isset($msg)){ echo $msg;  }?></span>
                                         <form action="applications_copy.php" method="POST">
                                        <div class="form-row">
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="" name="regNum" value="<?php if(isset($refNNum) ){ $_SESSION['regNum']= "CHST/2021/0".rand(1, 999); echo $_SESSION['regNum'];  } else { echo $refNNum.$school.'2021'; } ?>"  readonly required />
                                                    </div>
                                                </div>
                                                </div>
