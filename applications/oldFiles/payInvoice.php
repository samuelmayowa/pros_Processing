...
<html lang="en">
    ...
    <ul class="form-style-1">
        ...
        <li>
            ...
            <input type="text" id="js-narration" name="narration" class="form-control py-4" value="2021/2022 Online Application Form" readonly />
        </li>
         <li>
            <label>Payment Reference <span class="required">*</span></label>
            <input type="text" id="js-reference" name="reference" class="form-control py-4" value="2021/2022 Online Application Form" readonly />
        </li>
        <li>
...
function makePayment() {
        ...
        var paymentEngine = RmPaymentEngine.init({
            ...
            window.location.href ='makePayments.php?payID='+Math.floor((Math.random() * 1000000000) + 1);
