                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Upload Your Credentials</h3></div>
                                     <div class="card-body"><?php if(isset($msg)){ echo $msg; } ?>
                                         <form action="uploadPassport_copy.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-3" id="inputLastName" type="file" name="foto" placeholder="your Passport"  value="" required />
                                                    </div>
                                                </div>
