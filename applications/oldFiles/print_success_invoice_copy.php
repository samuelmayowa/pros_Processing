            ...
            <ul class="navbar-nav ml-auto ml-md-0" style="color:#fff;">
                ...
                <main>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Receipt For 2020/21 Online Application Form </h3></div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="#" method="POST"> 
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                            <div class="form-group">
                                            <div class="form-group mt-4 mb-0"><a href="/applications_copy.php" class="btn btn-primary btn-block">Proceed To Application</a></div>
                                            </div>
                                            </div>
