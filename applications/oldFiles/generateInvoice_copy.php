...
if(isset($_POST['invoice'])){
    ...
    if($statusCode == '025' && !empty($refNNum)){
     $type = '2020/2021 Application Form';
       ...
       header("location:invoice_copy.php?user={$username}"); 
    }
    if($success){
        $msg=$success;
   ...
   // $statusCode = $rrdata['rrr_statuscode'];
    ...
    if(!empty($rrdataPaid)){
    header("location:print_success_invoice_copy.php?user={$username}");
}elseif(empty($rrdata)){
                                       ...
                                       <div class="col-md-6">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group mt-4o mb-0"><a href="/manual-rrr.php" class="btn btn-primary btn-block" >Click to Validate RRR</a></div>
                                                 </div>
