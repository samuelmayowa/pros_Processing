...
if(isset($_POST['creatAccount'])){
    ...
    if($password != $confPassword){
       $msg=  "<script> alert('Your Password Does Not match');<script>";
        ...
        $query=mysqli_query($con,"INSERT INTO userAccounts (FirstName, MidName, LastName, Email,ApplicationType, Username , Password, PhoneNumber)
                                VALUES('$fname','$midname', '$lname', '$email','$applType', '$username', '$password', '$phno')");
                                ...
                                if(!$query){
                                  ...
                                  //$msg ="<script> alert('There Was Error Creating Your Account')<script>";
                                   ...
                                   header('location:login.php?id='.$username . ' && msg=Your Account Created Successfully');
                                }
             }
    }
        //}
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="utmeaccounts.php" method="POST"> 
                                            <div class="form-row">
                                             ...
                                             <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputConfirmPassword">Username: &nbsp; <span style="color:red; font-family:comic sans MS; font-size:11px;"> <?php if(isset($msg)){ echo $msg; } ?></span></label>
                                            ...
                                            <div class="form-row">
                                             ...
                                             <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Type Of Application</label>
                                                <!--<input class="form-control py-4" id="inputEmailAddress" name="email" type="email" aria-describedby="emailHelp" placeholder="Enter email address" value="<?php if(isset($email)){ echo  $email; } ?>"  required />-->
                                                <select name="applType" size="1" class="form-control py-4">
                                                            <option value="0">Seleect Applicatication Type </option>
                                                            <option value="<?php $y=date("Y"); echo $y .'/';  $d=date("Y"); echo $d+=1; ?> POST UTME Application Form"><?php $y=date("Y"); echo $y .'/';  $d=date("Y"); echo $d+=1; ?> POST UTME Application Form</option>
                                                            <option value="<?php $y=date("Y"); echo $y .'/';  $d=date("Y"); echo $d+=1; ?> Direct Application"><?php $y=date("Y"); echo $y .'/';  $d=date("Y"); echo $d+=1; ?>  Direct Entry Application </option>
                                                            </select>
                                            </div>
