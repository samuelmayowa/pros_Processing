...
$hash_value =hash("sha512",$MerchantID.$refNNum.$ApiKey);
    ...
    $responseUrl = 'https://'.$_SERVER['SERVER_NAME'].'/response_compulsory.php';
            ...
            <ul class="navbar-nav ml-auto ml-md-0" style="color:#fff;">
                ...
                <main>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Invoice For 2021/2022 Online Compulsory Form Payment Gateway  [By REMITA] </h3></div>
